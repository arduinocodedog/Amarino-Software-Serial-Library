...
class MeetAndroidSS : public Print
{
...
public: 
	// public methods
	MeetAndroidSS(H_voidFuncPtr err, uint16_t baudrate, uint8_t rxpin, uint8_t txpin);
	MeetAndroidSS(uint16_t baudrate, uint8_t rxpin, uint8_t txpin);
	...
	SoftwareSerial *getSerial() { return SSerial; }
